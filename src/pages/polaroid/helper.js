...
export function updateDepth(book, newPage) {
...
// export function moveBar(yes) {
// 	if (Modernizr && Modernizr.csstransforms) {
// 		$('#slider .ui-slider-handle').css({zIndex: yes ? -1 : 10000});
// 	}
// }

// export function setPreview(view) {
